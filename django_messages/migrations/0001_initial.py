    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_msg', models.ForeignKey(related_name='next_messages', on_delete=models.DO_NOTHING,
                                                 verbose_name='Parent message', blank=True, to='django_messages.Message', null=True)),
                ('recipient', models.ForeignKey(related_name='received_messages', on_delete=models.DO_NOTHING,
                                                verbose_name='Recipient', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('sender', models.ForeignKey(related_name='sent_messages',
                                             on_delete=models.DO_NOTHING, verbose_name='Sender', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-sent_at'],
